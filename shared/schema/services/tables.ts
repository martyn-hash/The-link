...
export const services = pgTable("services", {
  ...
  chTargetDeliveryDaysOffset: integer("ch_target_delivery_days_offset"),
...
export const clientServices = pgTable("client_services", {
  ...
  intendedTargetDeliveryDay: integer("intended_target_delivery_day"),
  isActive: boolean("is_active").default(true),
  ...
  index("idx_client_services_target_delivery_date").on(table.targetDeliveryDate),
...
export const peopleServices = pgTable("people_services", {
  ...
  index("idx_people_services_target_delivery_date").on(table.targetDeliveryDate),
